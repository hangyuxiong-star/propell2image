  ...
  ({ canvasId, theme, initialData, onDataChange, onImageToInput, onThemeChange, on3DModelClick, onVideoClick, onModalClose: _onModalClose, onReady }, ref) => {
    ...
    useEffect(() => {
      ...
      const processMenu = (contextMenu: Element) => {
        ...
        try {
          ;(contextMenu as HTMLElement).classList.add('propell2image-excalidraw-menu')
        } catch {
          // ignore
        }
        ...
        if (is3DModel && on3DModelClick && linkData) {
          ...
          view3DItem.className = 'context-menu-item propell2image-context-menu-item'
        ...
        if (onImageToInput) {
          ...
          menuItem.className = 'context-menu-item propell2image-context-menu-item'
        ...
        const allSeparators = contextMenu.querySelectorAll('hr, [role="separator"], .propell2image-context-separator')
